...
Instax, 10×15…), grade que **encaixa sozinha** na folha (nada cortado), marcas
de corte / contorno, efeitos de canto (fita, grampo, mini brad, percevejo),
ajustes de foto por item e um indicador de resolução que avisa se a foto vai
sair borrada no tamanho escolhido.

Tem **interface própria de celular** (abas Fotos / Folha / Estilo / Exportar) e
um **guia do usuário** ilustrado em `guia.html`.
...
```
index.html            marcação (interface de desktop + #mroot de celular)
